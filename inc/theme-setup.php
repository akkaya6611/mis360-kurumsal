    ...
    if (!get_option('mis360_sample_posts_seeded_v1')) {
        ...
        $sample_posts = [
            ...
            [
                ...
                'content'  => 'Geleneksel lezzetlerin başında gelen kuzu tandır, MİS360 mutfağında özel toprak güveç kaplarında ve taş fırının dinlenmiş közünde tam 4 saat boyunca pişirilir. Lokum gibi kemiğinden ayrılan et, yanında tereyağlı pirinç pilavı ve közlenmiş biberlerle ziyafet masalarının baş tacı olur.',
                'excerpt'  => 'Geleneksel toprak güveç kaplarında taş fırının dinlenmiş közünde 4 saat ağır ateşte lokum gibi pişen kuzu tandır.',
                'cats'     => [$cat_blog_id],
                'img'      => 'https://misteknoloji360.com.tr.tr/wp-content/uploads/2026/05/restaurant.jpg',
            ],
            [
                'title'    => 'Mevsimin En Taze Balıkları MİS360 Tezgahında: Çupra, Levrek ve Somon',
