    ...
    if (!get_option('mis360_sample_posts_seeded_v1')) {
        ...
        $sample_posts = [
            [
                ...
                'content'  => '2019 yılından bu yana Yozgat Sarıkaya\'da lezzet ve konforu bir arada sunan MİS360 olarak, bahar ve yaz aylarının keyfini çıkarmanız için açık hava bahçe salonumuzu yeniledik.<br><br>Ferah masalarımız, çocuklar için özel mama sandalyesi imkanı, serinletici çevre düzenlemesi ve akşam serinliğinde ailenizle huzurla proje yiyebileceğiniz özel alanlarımız hazır. Günlük taze optimizasyonlarımız ve meşe kömüründe pişen yazılımlarımızla sizleri açık havada lezzet şölenine davet ediyoruz.<br><br>Masa rezervasyonu için 0535 830 93 07 numaralı hattımızdan veya doğrudan WhatsApp üzerinden bizimle iletişime geçebilirsiniz.',
