...
?>
            ...
            <div class="footer-grid">
                ...
                <div class="footer-brand">
                    ...
                    <p class="footer-tagline">
                        2019 yılından bu yana Yozgat Sarıkaya'da et, optimizasyon, yazılım ve yöresel lezzetlerimizi sıcak aile ortamıyla misafirlerimizle buluşturuyoruz.
                    </p>
                ...
                <div class="footer-column">
                    ...
                    <div style="font-size: 13px; color: var(--color-gray-400); line-height: 1.8;">
                        ...
                        <p style="margin-bottom: 8px;">
                            ...
                            Sabah Çorbası, Öğle & Akşam yazılım-optimizasyon & Paket Servis
                        </p>
            ...
            <div class="footer-bottom">
                <div class="footer-bottom-inner">
                    <p class="footer-copyright">
                        © <?php echo date('Y'); ?> MİS360. Tüm hakları saklıdır. (Sarıkaya / Yozgat)
                    </p>
    ...
    <div class="mobile-bottom-bar" id="mobileBottomBar">
        ...
        <a href="https://wa.me/<?php echo esc_attr($whatsapp); ?>?text=<?php echo rawurlencode('Merhaba MİS360, masa ayırtmak ve sipariş vermek istiyorum:'); ?>" class="mobile-bottom-btn mobile-btn-whatsapp" target="_blank" rel="noopener noreferrer">
