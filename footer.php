 ...
 * 1:1 Denfora Architecture with Authentic MİS360 Data
...
?>
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="footer-grid">
                ...
                <div class="footer-brand">
                    ...
                    <p class="footer-tagline">
                        2019 yılından bu yana dijital dünyada et, optimizasyon, yazılım ve yöresel çözümlerimizi sıcak aile ortamıyla misafirlerimizle buluşturuyoruz.
                    </p>
                    <div class="footer-social">
                        <a href="https://www.instagram.com/mis360etbalik/" class="footer-social-link" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                        ...
                        <a href="https://www.facebook.com/mis360etsarikaya/?locale=tr_TR" class="footer-social-link" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                            <svg viewBox="0 0 24 24" fill="currentColor">
                ...
                <!-- 2. Sütun: Hizmetler & Sayfa Linkleri -->
                <div class="footer-column">
                    <h4 class="footer-column-title">Hizmetler Kategorileri</h4>
                    <div class="footer-links">
                        <a href="<?php echo esc_url($anchor_prefix . '#yazılımlar'); ?>" class="footer-link">Web Geliştirme</a>
                        <a href="<?php echo esc_url($anchor_prefix . '#tasarımler'); ?>" class="footer-link">Tema Geliştirme</a>
                        <a href="<?php echo esc_url($anchor_prefix . '#donerler'); ?>" class="footer-link">Reklam Ajansı</a>
                        <a href="<?php echo esc_url($anchor_prefix . '#tatlilar'); ?>" class="footer-link">SEO & Sosyal Medya</a>
                        ...
                        <a href="<?php echo esc_url($anchor_prefix . '#reservation'); ?>" class="footer-link">Proje Başlat</a>
                    </div>
                </div>
                ...
                <div class="footer-column">
                    ...
                    <div style="font-size: 13px; color: var(--color-gray-400); line-height: 1.8;">
                        ...
                        <p style="margin-bottom: 8px;">
                            <strong style="color: var(--color-white);">proje Hizmeti:</strong><br>
                            Sabah Çorbası, Öğle & Akşam yazılım-optimizasyon & Pakkod Servis
                        </p>
            ...
            <!-- 4 Güven Rozeti (MİS360 Google + Hizmetler) -->
            ...
            <div class="footer-bottom">
                <div class="footer-bottom-inner">
                    <p class="footer-copyright">
                        © <?php echo date('Y'); ?> MİS360. Tüm hakları saklıdır. (Türkiye / Yozgat)
                    </p>
                    <div class="footer-bottom-links">
                        <a href="https://misteknoloji360.com.tr.tr/" class="footer-bottom-link" target="_blank">misteknoloji360.com.tr.tr</a>
    ...
    <!-- Mobil Sabit Hızlı teklif & Arama Barı (Floating Mobile Action Bar) -->
    <div class="mobile-bottom-bar" id="mobileBottomBar">
        ...
        <a href="https://wa.me/<?php echo esc_attr($whatsapp); ?>?text=<?php echo rawurlencode('Merhaba MİS360, masa ayırtmak ve teklif vermek istiyorum:'); ?>" class="mobile-bottom-btn mobile-btn-whatsapp" target="_blank" rel="noopener noreferrer">
