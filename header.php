...
<div id="page" class="site-wrapper">
    ...
    <div class="site-header-wrapper" id="siteHeaderWrapper">
        <!-- Üst Bilgi Barı (Denfora + MİS360) - Masaüstünde görünür, mobilde gizlenir -->
        <div class="top-bar">
        ...
        <div class="header-inner">
            ...
            <a href="<?php echo esc_url(home_url('/')); ?>" class="header-logo" rel="home">
                <img src="<?php echo esc_url($logo_url); ?>" alt="MİS360" style="height: 48px; width: auto; object-fit: contain; display: block;" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
            ...
            <div class="header-actions">
                <!-- WhatsApp Butonu (+90 546 772 16 66 Hattına Bağlı) -->
    ...
    <div class="mobile-nav-overlay" id="mobileNavOverlay">
        <nav class="mobile-nav" id="mobileNav">
            <div class="mobile-nav-header">
                <img src="<?php echo esc_url($logo_url); ?>" alt="MİS360 Logo" style="height: 40px; width: auto; object-fit: contain;">
